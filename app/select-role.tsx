...
const PORTALS = [
  ...
  },
  {
    ...
    iconBg: '#F3E8FF',
    iconColor: '#7C3AED',
    label: 'Driver & Lorry Marketplace',
    sublabel: 'Zomato-style Logistics: Browse live delivery orders across quarries (In-House & Private Transporters)',
    badge: 'Open Logistics',
    badgeBg: '#F3E8FF',
    badgeColor: '#7C3AED',
  },
  {
    ...
    iconBg: '#E3F2FD',
    iconColor: '#1565C0',
    label: 'Driver Portal (My Trips)',
    sublabel: 'View active assigned trips, eWay bills, weighment slips & map navigation',
    badge: 'Drivers',
    badgeBg: '#E3F2FD',
    badgeColor: '#1565C0',
  },
