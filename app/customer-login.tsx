    ...
    <KeyboardAvoidingView style={styles.root} behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
      ...
      >
        ...
        <View style={styles.form}>
          ...
          >
            {loading
              ...
              : (
                <>
                  <Text style={styles.loginBtnText}>Log In & Browse Quarries</Text>
        ...
        <TouchableOpacity style={{ marginTop: 24, alignSelf: 'center', padding: 8 }} onPress={() => router.push('/customer-register')}>
          <Text style={{ fontSize: 13, color: Colors.textSecondary }}>New Customer? <Text style={{ fontWeight: '800', color: '#2E7D32' }}>Register your business account here &gt;</Text></Text>
        </TouchableOpacity>
